<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrontPage.aspx.cs" Inherits="WebApplication1.WebForm6" %>
...
<body style ="background-color:#ffffe0">
    <form id="form1" runat="server">
        <h1 style ="font-size:40px; font-style: italic;"; face = "Verdana"> MFA, The Museum Of Fine Arts
            <asp:Button ID="CollectionsButton" runat="server" Text="Collections" />
            <asp:Button ID="EventsButton" runat="server" Text="Events " Width="117px" />
            <asp:Button ID="Button1" runat="server" Text="Films" />
